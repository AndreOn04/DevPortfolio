...
const Projects = () => {
    const projectJson = [
        ...
        {
            title: 'Travel Story',
            desc: 'Aplicação para compartilhamento de viagens! - Em Desenvolvimento.',
        }
    ]
    
  return (
    <section id='project' className='relative bg-gray-700 py-10 px-4 font-inter mt-20'>
        <div className='mb-16 max-w-7xl mx-auto'>
            <h2 className='text-3xl font-bold mb-8 text-white border-b border-red-500 w-max pb-4'>Projetos</h2>
            <div className='grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 place-items-center gap-10'>
                {projectJson.flatMap((items) => {
