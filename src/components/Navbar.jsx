        ...
        <div className='max-w-7xl mx-auto flex h-14 items-center'>
            <div className='md:mr-4 flex justify-between w-full'>
                ...
                <nav className='md:flex hidden items-center space-x-6 text-lg font-medium'>
                    <a href="#about" className='transition-colors hover:text-foreground/80 text-foreground/60'>Sobre Mim</a>
                    <a href="#project" className='transition-colors hover:text-foreground/80 text-foreground/60'>Projetos</a>
