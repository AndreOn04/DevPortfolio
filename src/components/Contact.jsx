...
const Contact = () => {
  return (
    <section
      id="contact"
      className="z-50 bg-gray-800 relative py-10 px-5 md:px-0 font-inter"
    >
        ...
        <div className="flex flex-col md:flex-row justify-between items-center">
          <div className="md:w-1/2 mb-8 ml-2 md:mb-0">
            ...
            <p className="mb-4 text-white/85">
              Estou sempre aberto a novas oportunidades e colaboração. Sinta-se
              à vontade para entrar em contato!
            </p>
            <div className="flex space-x-4">
              <a
                href="https://www.linkedin.com/in/marcioandre-dev"
                target="_blank"
              ...
              <a
                href="https://github.com/AndreOn04"
                target="_blank"
                className="text-foreground/60 hover:text-foreground/80"
              >
